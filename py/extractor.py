...
def process_others(out, content, i, d):
    parts = content.split("****")
    ...
    for part in parts:
        ...
        for line in part.split("\n"):
            ...
            if line.startswith("## Oss") or line.startswith("## Cor") or line.startswith("## Lem") or line.startswith("## Ex") or line.startswith("## Alg") or line.startswith("## Teorema cinese dei resti"):
                s2.append("\n## Teorema " + str(i) + "\n")
                i += 1
...
with open("mds/teoremi-fondamentali.md") as TF:
    out, i, d = process_others(out, TF.read(), i, d)

with open("mds/algoritmi.md") as A:
    out, i, d = process_others(out, A.read(), i, d)
